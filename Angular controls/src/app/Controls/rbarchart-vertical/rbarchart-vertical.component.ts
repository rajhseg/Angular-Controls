    ...
    if(this.bar && this.context && this.Columns.length > 0 && this.xAxisItemNames.length > 0){
      ...
      for (let index = 0; index < this.Columns.length; index++) {
        ...
        if(element){
          ...
          let list: number[] = element.yAxisValues;
      ...
      var eachBarLength = eachBarGroupLength / (this.Columns.length + 2) ;
      let xPoint = StartX;
      ...
      for (let index = 0; index < itemCount; index++) {
        ...
        let remWidth = eachBarGroupLength - nameWidth.width - (eachBarLength * 2);
        ...
        for (let x = 0; x < this.Columns.length; x++) {
          ...
          let value = element.yAxisValues[index];
  ...
  private IsBarItemListEqual(a: BarChartItem[], b: BarChartItem[]){
    ...
    for (let index = 0; index < a.length; index++) {
      ...
      if(element1.DisplayName != element2.DisplayName || 
        ...
        element1.yAxisValues.toString() != element2.yAxisValues.toString()) {
          return false;
        }
    }
