...
export function ValidateCustomTypeProp<T extends object>(Type: new (...args: any[]) => T) {
...
export function ValidateProp(type: 'any' | 'size' | 'object' | 'objectarray' | 'enum' | 'color' | 'colorarray' | 'colororcolorarray' | 'number' | 'numberarray' 
